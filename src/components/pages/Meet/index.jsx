...
const Meet = () => {
    return (
        <div className="all-center w-full z-20 md:pl-20 pl-0">
            <div className="flex-col m-auto md:max-w-[80%] max-w-full all-center">
                <div className="">
                    <img src={AvatarMeet} alt="Item EOG" className="md:w-[640px] w-[400px] md:h-[330px] h-[380px] md:rounded-none rounded-2xl" />
                </div>
                <h1 className="text-title-box md:text-black text-white md:text-start text-center md:text-[94px] text-[52px] md:mt-0 mt-10">WOJAK</h1>
