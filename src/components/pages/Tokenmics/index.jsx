...
const Tokenmics = () => {
    const contractAddress = '0x7b6bB37A758173883772d73505741302B6D27Ff7';
    ...
    return (
        <>
            <div className="flex-col z-20 md:pt-10 pt-20 md:pl-20 pl-0 md:pb-0 pb-10">
