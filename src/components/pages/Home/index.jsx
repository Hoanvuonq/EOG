...
import Avatar from "../../../assets/avatar-version-11.jpg" 
        ...
        <div className="w-full h-full relative z-10"> 
            <div className="bg-custom w-full h-full relative z-30">
                ...
                <div className="md:h-screen h-full w-full flex-col z-40 all-center ">
                        <img src={Avatar} alt="Item EOG" className="relative md:w-[340px] w-[380px] md:h-[340px] h-[380px] rounded-2xl all-center border-8  md:mt-0 mt-20 md:right-[24%] right-0 z-40 border-white" />
                    <h1 className="text-title text-white with-shadow md:absolute relative top-20 md:right-96 right-0 md:hidden block">$UP</h1>
