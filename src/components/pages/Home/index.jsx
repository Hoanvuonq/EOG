    ...
    return (
        <div className="w-full h-full relative z-10">
            <div className="bg-custom w-full h-full relative z-30">
                <Design />
                <div className="sm:bg-inherit bg-[#01010157] md:h-screen h-full w-full flex-col z-40 all-center ">
                    ...
                    <h1 className="text-title text-white with-shadow md:absolute relative top-20 md:right-96 right-0 md:hidden block">#DAWAE</h1>
