                ...
                <div className="md:h-screen h-full w-full z-40 all-center md:flex-row flex-col md:px-0 px-2">
                    <div className="w-full all-center md:flex-row flex-col max-w-[1440px]">
                        <div className="relative z-[60] w-full all-center md:mt-0 mt-10">
                            <img src={Avatar} alt="Item EOG" className="md:w-[500px] w-[90%] md:h-[500px] h-auto" />
                        </div>
                        ...
                        <div className="md:absolute relative top-0 md:hidden flex w-full md:justify-between justify-center px-10 md:pt-5 pt-32">
                            <div className="all-center md:gap-6 gap-10 flex-col">
                                <Link to={'/'}>
                                    <button className="text-token bg-box-tokenomics flex flex-col gap-2 text-white py-7 text-center px-6 md:!w-[400px] !w-[360px] md:!h-[150px] !h-[140px] shadow-custom all-center md:!justify-start !justify-center rounded-2xl ">
                                        <p className='text-[#1257FA]'>TELEGRAM</p>
                                    </button>
                                </Link>
                                <Link to={'/'}>
                                    <button className="text-token bg-box-tokenomics flex flex-col gap-2 text-white py-7 text-center px-6 md:!w-[400px] !w-[360px] md:!h-[150px] !h-[140px] shadow-custom all-center md:!justify-start !justify-center rounded-2xl ">
                                        <p className='text-[#1257FA]'>TWITTER</p>
                                    </button>
                                </Link>
                            </div>
                        </div>
                        <div className="md:flex flex-col gap-8 hidden w-full relative mt-12 -ml-20">
                            <Meet />
                            <TokenmicsHome />
                        </div>
                    </div>
