        ...
        <div className="bg-[#00500D] w-full h-full">  
            <div className="bg-custom w-full h-full">
                <div className="all-center w-full pt-[100px] flex-col">
                    ...
                    <p className="text-content text-white text-center sm:px-0 px-2">Pepe The World Eater</p>
                    <div className="all-center gap-10 mt-10 sm:flex-row flex-col">
                        ...
                        <Link to={"https://t.me/PepeTheEarthEatter"} target="_blank">
                        ...
                        <Link to={"https://twitter.com/PepeEarthEatter"} target="_blank">
